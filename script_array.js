...
var pages = [{
  ...
  },
  {
    ...
    definition: "This is an Italian term which literally means 'light-dark'. In paintings the description refers to clear tonal contrasts which are often used to suggest the volume and modelling of the subjects depicted.",
  ...
  },
  {
    ...
    page: "foreshortening.html",
    etymology: "from c. 1600: fore- + shorten",
    definition: "Foreshortening is a technique used in perspective to create the illusion of an object receding strongly into the distance or background. The illusion is created by the object appearing shorter than it is in reality. The object appears compressed. Foreshortening applies to everything that is drawn in perspective, including buildings, landscapes, still life objects, and figures.",
    introDirections: "While you watch the video, consider how you would identify and describe foreshortening.",
    introVideo: "https://www.youtube.com/embed/_enw8gnHNX4",
    lectureDirections: "Watch the video and take notes below. Be sure to save your notes when you are finished.",
